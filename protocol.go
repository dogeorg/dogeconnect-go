...
type ConnectPayment struct {
	...
	VendorName    string          `json:"vendor_name,omitempty"`    // vendor display name
	...
	Items         []ConnectItem   `json:"items,omitempty"`          // List of line items to display
...
type ConnectItem struct {
	...
	Tax         string `json:"tax,omitempty"` // tax on this item, DECMIAL string (optional)
}
